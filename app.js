...
const categoryMapping = {
    ...
    '일식': ['일식', '돈까스', '회', '초밥', '라멘', '우동', '소바', '일본요리', '스시', '사시미',
            ...
            '카레', '돈부리', '텐푸라', '야끼니꾸', '사케동', '이크라동', '장어덮밥', '연어덮밥',
            '치라시', '모듬초밥', '모듬회', '쯔케멘', '나베', '샤부샤부', '스키야끼', '야키토리',
            '카츠', '가라아게', '에비후라이', '이자카야', '토리카츠'],
...
const foodFormKeywords = {
    '밥': ['덮밥', '비빔밥', '볶음밥', '쌈밥', '정식', '백반', '한정식', '고기', '삼겹살', '갈비', 
          ...
          '규동', '오므라이스', '리조또', '오야코동', '텐동', '가츠동', '사케동', '장어덮밥',
          '연어덮밥', '치라시', '육회', '알밥', '명란', '성게', '보쌈', '족발', '찜', '탕',
          '전골', '국밥', '해장국', '설렁탕', '곰탕', '갈비탕', '추어탕', '순대국', '뼈해장국',
          '감자탕', '부대찌개', '돌솥', '쌀', '밥상', '한식', '찌개', '조림', '구이', '회',
          '사시미', '스시', '중식', '탕수육', '중화요리', '만두', '짬뽕밥', '카오팟', '나시고랭',
          '해남치킨라이스', '분짜', '반미', '치킨', '스테이크', '함박', '미트볼', '돈부리'],
...
const menuKeywords = {
    ...
    '일식': ['초밥', '라멘', '돈까스', '우동', '회', '소바', '규동', '텐동', '사시미', '스시',
            '오코노미야키', '타코야끼', '야키소바', '가츠동', '오야코동', '카레', '텐푸라',
            '사케동', '장어덮밥', '연어덮밥', '치라시', '쯔케멘', '돈코츠라멘', '토리카츠'],
